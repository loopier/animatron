...
=== /color/preset actor:a color:s

Modulate the ACTOR using the COLOR preset.

=== /color/preset/add name:s r:f g:f b:f

Create a color preset and add it to memory.

=== /color/preset/remove name:s

Remove a color preset from memory.

=== /color/presets/list 

Get the list of available color presets
...
Writes command to editor so it can be modified.
