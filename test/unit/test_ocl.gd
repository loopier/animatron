...
func test_getVariable():
	assert_eq(ocl._getVariable("$i", 0, ["/post", "$i"]), ["/post", 0])
	assert_eq(ocl._getVariable("$i", 2, ["/scale", "bla", "$i", 0.5]), ["/scale", "bla", 2, 0.5])
	assert_eq(ocl._getVariable("$i", 2, ["/scale", "bla$i", 0.5, 0.5]), ["/scale", "bla2", 0.5, 0.5])
	
	assert_eq(ocl._getVariable("$i", 0, ["/scale", "bla$i", 0.5, 0.5]), ["/scale", "bla0", 0.5, 0.5])
	assert_eq(ocl._getVariable("$i", 1, ["/scale", "bla$i", 0.5, 0.5]), ["/scale", "bla1", 0.5, 0.5])
